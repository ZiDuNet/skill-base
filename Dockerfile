...
FROM registry.cn-hangzhou.aliyuncs.com/library/node:20.20.2-alpine3.22 AS builder
...
FROM registry.cn-hangzhou.aliyuncs.com/library/node:20.20.2-alpine3.22
