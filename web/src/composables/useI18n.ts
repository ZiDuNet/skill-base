...
const zh: Record<string, string> = {
  ...
  'quickStart.agent.step1CodeB': '从 https://4dbim-chaoxi.oss-cn-shanghai.aliyuncs.com/deploy/skills/skillbase/SKILL.md 拉取 skb 并安装到你的 skills 目录。',
  'quickStart.agent.step2Label': '配置服务器',
  'quickStart.agent.step2Desc': '让助手配置 CLI 指向当前 Skill Base 服务器。',
  'quickStart.agent.step2Code': '帮我配置 Skill Base，服务器地址是 {url}。',
  'quickStart.agent.step3Label': '搜索',
  'quickStart.agent.step3Desc': '让助手帮你搜索需要的 Skill。',
  'quickStart.agent.step3Code': '用 skb 搜索 some-skill。',
  'quickStart.agent.step4Label': '安装',
  ...
  'quickStart.agent.step5Label': '更新',
...
const en: Record<string, string> = {
  ...
  'quickStart.agent.step1CodeB': 'From https://4dbim-chaoxi.oss-cn-shanghai.aliyuncs.com/deploy/skills/skillbase/SKILL.md pull skb and install it into your skills directory.',
  'quickStart.agent.step2Label': 'Configure',
  ...
  'quickStart.agent.step3Label': 'Search',
  ...
  'quickStart.agent.step4Label': 'Install',
  ...
  'quickStart.agent.step5Label': 'Update',
