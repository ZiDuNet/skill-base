...
const zh: Record<string, string> = {
  ...
  // Quick Start
  'quickStart.pageTitle': '如何快速使用 Skill Base？',
  'quickStart.pageSubtitle': '选择你喜欢的方式开始使用',
  'quickStart.copy': '复制',
  'quickStart.copied': '已复制',
  'quickStart.or': '或',
  'quickStart.tabAgent': '让 Agent 帮我装',
  'quickStart.tabManual': '我自己装',

  // Agent tab
  'quickStart.agent.step1Label': '安装 CLI',
  'quickStart.agent.step1Desc': '两种方式任选其一，让助手帮你安装 skill-base-cli。',
  'quickStart.agent.step1CodeA': '从 ClawHub 拉取 skill-base-cli 并安装到你的 skills 目录。',
  'quickStart.agent.step1CodeB': '从 https://cdn.chaoxi.live/deploy/skills/skillbase/SKILL.md 拉取 skb 并安装到你的 skills 目录。',
  'quickStart.agent.step2Label': '连接到这里',
  'quickStart.agent.step2Desc': '让助手配置 CLI 指向当前 Skill Base 服务器。',
  'quickStart.agent.step2Code': '帮我配置 Skill Base，服务器地址是 {url}。',
  'quickStart.agent.step3Label': '怎么搜索',
  'quickStart.agent.step3Desc': '让助手帮你搜索需要的 Skill。',
  'quickStart.agent.step3Code': '用 skb 搜索 some-skill。',
  'quickStart.agent.step4Label': '安装 Skill',
  'quickStart.agent.step4Desc': '让助手帮你安装 Skill 到项目中。',
  'quickStart.agent.step4Code': '用 skb 安装 some-skill。',
  'quickStart.agent.step4Note': '可用 skill_id@版本 指定版本。一般不需要登录。',
  'quickStart.agent.step5Label': '更新 Skill',
  'quickStart.agent.step5Desc': '团队标准更新后，让助手一键同步到本地。',
  'quickStart.agent.step5Code': '用 skb 更新 some-skill。',
  'quickStart.agent.step5Note': '一般不需要登录。',
  'quickStart.agent.step6Label': '登录',
  'quickStart.agent.step6Desc': '完成身份验证，获取发布权限。',
  'quickStart.agent.step6Code': '帮我 skb login，验证码是 xxxx-xxxx',
  'quickStart.agent.step6Note': '验证码需在浏览器打开 {url}/cli-code 获取，五分钟有效期。',
  'quickStart.agent.step7Label': '发布',
  'quickStart.agent.step7Desc': '提交与上线，让助手帮你发布 Skill。',
  'quickStart.agent.step7Code': '调用 skb，发布刚写的 skill。',
  'quickStart.agent.step7Note': '发布 Skill 必须先登录。可让助手写 changelog 文案。',

  // Manual tab
  'quickStart.manual.s1Title': '安装 CLI',
  'quickStart.manual.s1Desc': '全局安装 skill-base-cli，初始化配置并完成登录。',
  'quickStart.manual.s1c1': '全局安装 CLI 工具',
  'quickStart.manual.s1c2': '初始化并连接到 Skill Base 服务器',
  'quickStart.manual.s1c3': '登录（在浏览器获取验证码）',
  'quickStart.manual.s2Title': '搜索安装',
  'quickStart.manual.s2Desc': '搜索并安装团队共享的 Skills。',
  'quickStart.manual.s2c1': '搜索可用的 Skills',
  'quickStart.manual.s2c2': '安装 Skill（可用 skill_id@版本 指定版本）',
  'quickStart.manual.s2d1': '开发最佳实践',
  'quickStart.manual.s2d2': 'Hooks 使用指南',
  'quickStart.manual.s3Title': '发布 Skill',
  'quickStart.manual.s3Desc': '创建并发布你自己的 Skill 到服务器。',
  'quickStart.manual.s3c1': '创建一个新的 Skill 目录',
  'quickStart.manual.s3c2': '编写 Skill 内容',
  'quickStart.manual.s3c3': '发布到服务器',
  'quickStart.manual.s3d1': '团队共享的 AI Agent 技能',
  'quickStart.manual.s3d2': '这里写你的 Skill 规则和指导内容...',
  'quickStart.manual.s3d3': '初始版本',
  'quickStart.manual.s4Title': 'IDE 集成',
  'quickStart.manual.s4Desc': '将 Skill 安装到你的 IDE，让 AI 助手自动加载。',

  // FAQ
  'quickStart.faqTitle': '常见问题',
  'quickStart.faqTabAgent': 'Agent 调教指南',
  'quickStart.faqTabUser': '我是使用者',
  'quickStart.faqTabAdmin': '我是管理员',

  // Agent 调教指南
  'quickStart.faq.g1q': '搜索 Skill',
  'quickStart.faq.g1a': '直接对 AI 助手说：<br><code>用 skb 搜索 xxx</code><br>把 xxx 换成你想找的关键词，比如 vue、接口规范、git 等。',
  'quickStart.faq.g2q': '安装 Skill',
  'quickStart.faq.g2a': '直接对 AI 助手说：<br><code>用 skb 安装 xxx</code><br>AI 会自动帮你下载并放到正确的目录。安装不需要登录。',
  'quickStart.faq.g3q': '更新 Skill',
  'quickStart.faq.g3a': '直接对 AI 助手说：<br><code>用 skb 更新 xxx</code><br>团队更新了规范后，跟 AI 说一句就行。更新不需要登录。',
  'quickStart.faq.g4q': '发布我自己写的 Skill',
  'quickStart.faq.g4a': '先让 AI 登录：<code>帮我 skb login，验证码是 xxxx-xxxx</code>（验证码在浏览器 {url}/cli-code 获取）。<br>然后说：<code>帮我发布 xxx 这个 Skill</code>。发布需要先登录。',
  'quickStart.faq.g5q': '安装到指定 IDE（Cursor / Claude Code 等）',
  'quickStart.faq.g5a': '对 AI 助手说：<br><code>用 skb 安装 xxx 到 Cursor</code><br>把 Cursor 换成你用的工具名，比如 Claude Code、Copilot、Windsurf、Qoder 等。',
  'quickStart.faq.g6q': '查看已安装的 Skill',
  'quickStart.faq.g6a': '直接对 AI 助手说：<br><code>帮我用 skb 看看装了哪些 Skill</code><br>AI 会列出你本地已安装的所有 Skill。',

  // 使用者 FAQ
  'quickStart.faq.u1q': '安装或更新 Skill 需要登录吗？',
  'quickStart.faq.u1a': '<b>小白用户（发给 Agent）：</b>直接跟 AI 说「帮我安装/更新 xxx Skill」就行，不需要登录。<br><br><b>技术用户：</b><code>skb install</code> 和 <code>skb update</code> 不需要登录，只有发布时才需要。',
  'quickStart.faq.u2q': 'AI 助手装完 Skill 后没有生效？',
  'quickStart.faq.u2a': '<b>小白用户（发给 Agent）：</b>跟 AI 说「把 xxx Skill 安装到 Cursor」（换成你用的工具名）。<br><br><b>技术用户：</b>安装时加 <code>--ide</code> 参数，例如 <code>skb install xxx --ide cursor</code>。如果还是不行，重启 IDE。',
  'quickStart.faq.u3q': '怎么知道装了哪些 Skill？',
  'quickStart.faq.u3a': '<b>小白用户（发给 Agent）：</b>跟 AI 说「帮我看看装了哪些 Skill」。<br><br><b>技术用户：</b>终端执行 <code>skb list</code>，会列出所有已安装的 Skill、路径和版本号。',
  'quickStart.faq.u4q': '团队更新了规范，我怎么同步？',
  'quickStart.faq.u4a': '<b>小白用户（发给 Agent）：</b>直接跟 AI 说「帮我更新 xxx Skill」。<br><br><b>技术用户：</b>终端执行 <code>skb update xxx</code>，选择版本即可。如果之前用 <code>--ide</code> 安装的，CLI 会记住路径自动更新。',
  'quickStart.faq.u5q': '我是产品经理 / 测试，完全不会用终端怎么办？',
  'quickStart.faq.u5a': '选择上方的「让 Agent 帮我装」，把每一步的提示词直接复制发给你的 AI 助手。AI 会帮你搞定一切，你完全不需要碰终端。',

  // 管理员 FAQ
  'quickStart.faq.a1q': '怎么部署 Skill Base 服务？',
  'quickStart.faq.a1a': '最简单的方式：<code>npx skill-base</code> 一行命令启动。数据默认存在当前目录的 <code>data/</code> 文件夹。也可以用 Docker：<code>docker compose up -d</code>。详细配置参考项目 README。',
  'quickStart.faq.a2q': '如何创建用户账号？',
  'quickStart.faq.a2a': '服务启动后，用浏览器打开服务地址，点击右上角「注册」。第一个注册的用户会自动成为管理员（super_admin）。管理员可以在「用户管理」中创建更多账号或调整角色。',
  'quickStart.faq.a3q': '怎么设置 Skill 为私有？',
  'quickStart.faq.a3a': '发布 Skill 时，在 Web 界面的发布页面勾选「私有」。私有 Skill 只有 owner、协作者和管理员能看到和安装。通过 <code>skb publish</code> 发布的默认是公开的。',
  'quickStart.faq.a4q': '如何管理团队成员的权限？',
  'quickStart.faq.a4a': '在 Web 界面进入 Skill 详情页，点击「协作者管理」可以添加团队成员。协作者可以安装私有 Skill 和发布新版本。管理员可以在「用户管理」中查看所有用户和角色。',
  'quickStart.faq.a5q': '数据存在哪里？如何备份？',
  'quickStart.faq.a5a': '数据库是 SQLite，文件在 <code>data/skills.db</code>；Skill 文件（ZIP）存在 <code>data/skills/</code> 目录。备份只需要把整个 <code>data/</code> 目录复制一份即可。',
}
...
const en: Record<string, string> = {
  ...
  // Quick Start
  'quickStart.pageTitle': 'How to get started with Skill Base?',
  'quickStart.pageSubtitle': 'Choose the way you prefer to get started',
  'quickStart.copy': 'Copy',
  'quickStart.copied': 'Copied',
  'quickStart.or': 'OR',
  'quickStart.tabAgent': 'Let Agent help me',
  'quickStart.tabManual': 'I\'ll do it myself',

  // Agent tab
  'quickStart.agent.step1Label': 'Install CLI',
  'quickStart.agent.step1Desc': 'Choose either method and ask your assistant to install skill-base-cli.',
  'quickStart.agent.step1CodeA': 'From ClawHub, pull skill-base-cli and install it into your skills directory.',
  'quickStart.agent.step1CodeB': 'From https://cdn.chaoxi.live/deploy/skills/skillbase/SKILL.md pull skb and install it into your skills directory.',
  'quickStart.agent.step2Label': 'Connect',
  'quickStart.agent.step2Desc': 'Ask the assistant to configure the CLI to point to this Skill Base server.',
  'quickStart.agent.step2Code': 'Help me configure Skill Base, the server URL is {url}.',
  'quickStart.agent.step3Label': 'How to Search',
  'quickStart.agent.step3Desc': 'Ask the assistant to search for the skill you need.',
  'quickStart.agent.step3Code': 'Use skb to search for some-skill.',
  'quickStart.agent.step4Label': 'Install Skill',
  'quickStart.agent.step4Desc': 'Ask the assistant to install a skill into your project.',
  'quickStart.agent.step4Code': 'Use skb to install some-skill.',
  'quickStart.agent.step4Note': 'Pin a version with skill_id@version. Login is usually not required.',
  'quickStart.agent.step5Label': 'Update Skill',
  'quickStart.agent.step5Desc': 'When team standards change, ask the assistant to sync the latest.',
  'quickStart.agent.step5Code': 'Use skb to update some-skill.',
  'quickStart.agent.step5Note': 'Login is usually not required.',
  'quickStart.agent.step6Label': 'Login',
  'quickStart.agent.step6Desc': 'Complete authentication to get publish access.',
  'quickStart.agent.step6Code': 'Help me with skb login, the verification code is xxxx-xxxx',
  'quickStart.agent.step6Note': 'Get the code by opening {url}/cli-code in your browser. Valid for 5 minutes.',
  'quickStart.agent.step7Label': 'Publish',
  'quickStart.agent.step7Desc': 'Submit and go live, ask the assistant to publish your skill.',
  'quickStart.agent.step7Code': 'Use skb to publish the skill I just wrote.',
  'quickStart.agent.step7Note': 'You must be logged in to publish. You can ask the assistant to write changelog copy.',

  // Manual tab
  'quickStart.manual.s1Title': 'Install CLI',
  'quickStart.manual.s1Desc': 'Install skill-base-cli globally, initialize config and login.',
  'quickStart.manual.s1c1': 'Install CLI tool globally',
  'quickStart.manual.s1c2': 'Initialize and connect to Skill Base server',
  'quickStart.manual.s1c3': 'Login (get verification code from browser)',
  'quickStart.manual.s2Title': 'Search & Install',
  'quickStart.manual.s2Desc': 'Search and install team-shared Skills.',
  'quickStart.manual.s2c1': 'Search available Skills',
  'quickStart.manual.s2c2': 'Install Skill (use skill_id@version to specify version)',
  'quickStart.manual.s2d1': 'development best practices',
  'quickStart.manual.s2d2': 'Hooks usage guide',
  'quickStart.manual.s3Title': 'Publish Skill',
  'quickStart.manual.s3Desc': 'Create and publish your own Skill to the server.',
  'quickStart.manual.s3c1': 'Create a new Skill directory',
  'quickStart.manual.s3c2': 'Write Skill content',
  'quickStart.manual.s3c3': 'Publish to server',
  'quickStart.manual.s3d1': 'Team shared AI Agent skill',
  'quickStart.manual.s3d2': 'Write your Skill rules and guidance here...',
  'quickStart.manual.s3d3': 'Initial version',
  'quickStart.manual.s4Title': 'IDE Integration',
  'quickStart.manual.s4Desc': 'Install Skills to your IDE for automatic AI assistant loading.',

  // FAQ
  'quickStart.faqTitle': 'FAQ',
  'quickStart.faqTabAgent': 'Agent Prompt Guide',
  'quickStart.faqTabUser': 'I\'m a User',
  'quickStart.faqTabAdmin': 'I\'m an Admin',

  'quickStart.faq.g1q': 'Search for a Skill',
  'quickStart.faq.g1a': 'Tell your AI assistant:<br><code>Use skb to search for xxx</code><br>Replace xxx with your keyword, e.g. vue, api, git.',
  'quickStart.faq.g2q': 'Install a Skill',
  'quickStart.faq.g2a': 'Tell your AI assistant:<br><code>Use skb to install xxx</code><br>The AI will download it to the right directory. No login needed.',
  'quickStart.faq.g3q': 'Update a Skill',
  'quickStart.faq.g3a': 'Tell your AI assistant:<br><code>Use skb to update xxx</code><br>Just say this when the team updates their standards. No login needed.',
  'quickStart.faq.g4q': 'Publish my own Skill',
  'quickStart.faq.g4a': 'First login: <code>Help me skb login, the code is xxxx-xxxx</code> (get the code at {url}/cli-code).<br>Then: <code>Help me publish the xxx Skill</code>. Publishing requires login.',
  'quickStart.faq.g5q': 'Install to a specific IDE (Cursor / Claude Code etc.)',
  'quickStart.faq.g5a': 'Tell your AI assistant:<br><code>Use skb to install xxx into Cursor</code><br>Replace Cursor with your tool: Claude Code, Copilot, Windsurf, Qoder, etc.',
  'quickStart.faq.g6q': 'View installed Skills',
  'quickStart.faq.g6a': 'Tell your AI assistant:<br><code>Use skb to show me what Skills are installed</code><br>The AI will list all locally installed Skills.',

  'quickStart.faq.u1q': 'Do I need to login to install or update Skills?',
  'quickStart.faq.u1a': '<b>For beginners (tell your Agent):</b> Just say «help me install/update xxx Skill» — no login needed.<br><br><b>For technical users:</b> <code>skb install</code> and <code>skb update</code> work without login. Login is only required for publishing.',
  'quickStart.faq.u2q': 'Skill installed but AI assistant doesn\'t use it?',
  'quickStart.faq.u2a': '<b>For beginners (tell your Agent):</b> Say «install xxx Skill into Cursor» (replace with your tool name).<br><br><b>For technical users:</b> Add <code>--ide</code> flag, e.g. <code>skb install xxx --ide cursor</code>. If it still doesn\'t work, restart your IDE.',
  'quickStart.faq.u3q': 'How do I see what Skills I\'ve installed?',
  'quickStart.faq.u3a': '<b>For beginners (tell your Agent):</b> Say «show me what Skills are installed».<br><br><b>For technical users:</b> Run <code>skb list</code> in your terminal to see all installed Skills with paths and versions.',
  'quickStart.faq.u4q': 'How do I sync when the team updates a Skill?',
  'quickStart.faq.u4a': '<b>For beginners (tell your Agent):</b> Just say «help me update xxx Skill».<br><br><b>For technical users:</b> Run <code>skb update xxx</code> in your terminal and pick a version. If you installed with <code>--ide</code>, CLI remembers the path.',
  'quickStart.faq.u5q': 'I\'m not a developer, how can I use this?',
  'quickStart.faq.u5a': 'Choose «Let Agent help me install» above, and send each prompt to your AI assistant. It will handle everything — no terminal needed.',

  'quickStart.faq.a1q': 'How do I deploy the Skill Base server?',
  'quickStart.faq.a1a': 'The simplest way: run <code>npx skill-base</code>. Data is stored in <code>data/</code> by default. You can also use Docker: <code>docker compose up -d</code>. See the project README for details.',
  'quickStart.faq.a2q': 'How do I create user accounts?',
  'quickStart.faq.a2a': 'Open the server URL in your browser and click «Register». The first registered user becomes super_admin automatically. Admins can manage users and roles in the «User Management» page.',
  'quickStart.faq.a3q': 'How do I make a Skill private?',
  'quickStart.faq.a3a': 'Check the «Private» option on the publish page in the Web UI. Private Skills are only visible to the owner, collaborators, and admins. Skills published via <code>skb publish</code> are public by default.',
  'quickStart.faq.a4q': 'How do I manage team permissions?',
  'quickStart.faq.a4a': 'Go to the Skill detail page in the Web UI and click «Manage Collaborators» to add team members. Collaborators can install private Skills and publish new versions. Admins can view all users in «User Management».',
  'quickStart.faq.a5q': 'Where is data stored? How do I back it up?',
  'quickStart.faq.a5a': 'The database is SQLite at <code>data/skills.db</code>; Skill files (ZIP) are in <code>data/skills/</code>. To back up, just copy the entire <code>data/</code> directory.',
}
